...
import 'package:arcinus/features/academy_users_payments/presentation/ui/widgets/widgets.dart';
...
import 'package:arcinus/features/academy_users_subscriptions/presentation/providers/period_actions_provider.dart';
import 'package:arcinus/features/academy_users_payments/presentation/ui/widgets/period_edit_dialog.dart';

// *** NUEVO: Importar el provider del EnhancedPaymentService ***
import 'package:arcinus/features/academy_users_payments/presentation/providers/enhanced_payment_providers.dart';
...
class RegisterPaymentScreenState extends ConsumerState<RegisterPaymentScreen> {
  ...
  AcademyMemberUserModel? _academyMember;
  ...
  Future<void> _initializeAsync() async {
    ...
    try {
      ...
      if (_selectedAthleteId != null) {
        ...
        final academyMemberAsync = await ref.read(academyMemberProvider(_selectedAthleteId!).future);
        ...
        try {
          ...
          setState(() {
            ...
            _academyMember = academyMemberAsync;
  ...
  void _invalidateProvidersAfterPayment() {
    ...
    if (_selectedAthleteId != null && academyId != null) {
      ...
      ref.invalidate(academyMemberCachedProvider(_selectedAthleteId!));
      ref.invalidate(academyMemberProvider(_selectedAthleteId!));
      ...
      try {
        final notifier = ref.read(academyMemberCachedProvider(_selectedAthleteId!).notifier);
        notifier.refresh();
  ...
  Future<void> _updateUserInfoFromPeriods() async {
    ...
    try {
      ...
      if (activePeriods.isNotEmpty) {
        ...
        await repository.updateAcademyMember(
          academyId,
          _selectedAthleteId!,
          {
