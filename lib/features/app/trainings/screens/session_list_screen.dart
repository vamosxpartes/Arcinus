...
class SessionListScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return BaseScaffold(
      ...
      onAddButtonTap: () {
        // Verificar si el entrenamiento es recurrente
        trainingService.getTrainingById(trainingId).first.then((training) {
          if (training.isRecurring) {
            // Mostrar opciones para entrenamientos recurrentes
            if (context.mounted) {
              showDialog(
                context: context,
                builder: (context) => AlertDialog(
                title: const Text('Crear Sesiones'),
                content: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    ListTile(
                      leading: const Icon(Icons.add_circle),
                      title: const Text('Sesión Individual'),
                      onTap: () {
                    ...
                    ListTile(
                      ...
                      title: const Text('Sesiones Recurrentes'),
                      onTap: () {
                        Navigator.pop(context);
            ...
            // Si no es recurrente, navegar directamente a la creación de sesión
            // Aquí iría la navegación a la pantalla de creación de sesión
          }
        }
        }
        );
