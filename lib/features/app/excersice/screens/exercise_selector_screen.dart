...
class _ExerciseSelectorScreenState extends ConsumerState<ExerciseSelectorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseScaffold(
      ...
      body: Column(
        children: [
          // Contenido principal en un Expanded
          Expanded(
            child: Column(
              children: [
                // Barra de búsqueda
          ...
          // Botón de confirmar (antes era bottomNavigationBar)
          if (_selectedExercises.isNotEmpty)
            Container(
              padding: const EdgeInsets.all(16.0),
              color: const Color(0xFF1E1E1E), // Dark Gray
              child: SafeArea(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      // Devolver los ejercicios seleccionados
                      Navigator.of(context).pop(_selectedExercises);
                    },
                    child: Text(
                      'Confirmar selección (${_selectedExercises.length})',
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
