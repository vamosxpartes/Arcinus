...
class _ClientAdapter implements payment_service.ClientUserRepository {
  final ClientUserRepository _repo;
  
  _ClientAdapter(this._repo);
  ...
  Future<Either<Failure, List<ClientUserModel>>> getClientUsers(
    ...
    return _repo.getClientUsers(
      academyId,
      clientType: clientType as AppRole?,
      paymentStatus: paymentStatus,
    );
  }
  ...
  Future<Either<Failure, bool>> updateClientUserPaymentStatus(
    ...
    return _repo.updateClientUserPaymentStatus(
      academyId,
      userId,
      newStatus,
    );
