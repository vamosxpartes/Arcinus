...
part 'features/app/sports/ux/models/sport_characteristics.freezed.dart';
part 'features/app/sports/ux/models/sport_characteristics.g.dart';
...
class SportCharacteristics with _$SportCharacteristics {
  ...
  factory SportCharacteristics.basketball() => const SportCharacteristics(
    athleteStats: [
      ...
      'puntos_por_partido', 'rebotes', 'asistencias', 'robos', 'tapones', 'eficiencia_tiro'
    ],
    statUnits: {
      'altura': 'cm',
      'peso': 'kg',
