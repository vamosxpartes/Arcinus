...
class CoachTab extends ConsumerWidget {
    ...
    return Column(
      children: [
        ...
        UserSearchBar(
          ...
          onAddPressed: () => _addCoach(context, ref),
          addButtonTooltip: 'Agregar Entrenador',
        ),
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              child: ListTile(
                ...
                onTap: () => _editCoach(context, ref, coach.id, currentAcademy.id),
              ),
            );
          },
        );
  ...
  void _addCoach(BuildContext context, WidgetRef ref) {
